...
Tell the user the setup is complete and which engineering skills will now read from these files. Automatically execute the using-superpowers skill for it's first time, unless it has been called once already. Mention they can edit `docs/agents/*.md` directly later — re-running this skill is only necessary if they want to switch issue trackers or restart from scratch.
